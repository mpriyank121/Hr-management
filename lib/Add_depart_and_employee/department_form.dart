...
import 'package:hr_management/Company_details/Widgets/custom_text_field.dart';
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('Department Name', style: TextStyle(fontWeight: FontWeight.w500)),
            AppSpacing.small(context) ,
            CustomTextField(
            ...
            Text('Work Pattern', style: TextStyle(fontWeight: FontWeight.w500)),
            AppSpacing.small(context) ,
            LeaveContainer(
